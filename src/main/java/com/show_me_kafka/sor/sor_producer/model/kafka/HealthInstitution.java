...
public class HealthInstitution extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9066497294954538577L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HealthInstitution\",\"namespace\":\"com.show_me_kafka.sor.sor_producer.model.kafka\",\"fields\":[{\"name\":\"SorIdentifier\",\"type\":\"string\"},{\"name\":\"EntityName\",\"type\":\"string\"},{\"name\":\"EntityTypeIdentifier\",\"type\":\"string\"},{\"name\":\"ParentSorIdentifier\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<HealthInstitution> ENCODER =
      new BinaryMessageEncoder<HealthInstitution>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<HealthInstitution> DECODER =
      new BinaryMessageDecoder<HealthInstitution>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<HealthInstitution> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<HealthInstitution> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<HealthInstitution>(MODEL$, SCHEMA$, resolver);
  }
  ...
  /** Deserializes a HealthInstitution from a ByteBuffer. */
  public static HealthInstitution fromByteBuffer(
   ...
   */
  public HealthInstitution(java.lang.CharSequence SorIdentifier, java.lang.CharSequence EntityName, java.lang.CharSequence EntityTypeIdentifier, java.lang.CharSequence ParentSorIdentifier) {
  ...
  /**
   * Creates a new HealthInstitution RecordBuilder.
   * @return A new HealthInstitution RecordBuilder
   */
  public static com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder newBuilder() {
    return new com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder();
  }

  /**
   * Creates a new HealthInstitution RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new HealthInstitution RecordBuilder
   */
  public static com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder newBuilder(com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder other) {
    return new com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder(other);
  }

  /**
   * Creates a new HealthInstitution RecordBuilder by copying an existing HealthInstitution instance.
   * @param other The existing instance to copy.
   * @return A new HealthInstitution RecordBuilder
   */
  public static com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder newBuilder(com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution other) {
    return new com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder(other);
  }

  /**
   * RecordBuilder for HealthInstitution instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HealthInstitution>
    implements org.apache.avro.data.RecordBuilder<HealthInstitution> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing HealthInstitution instance
     * @param other The existing instance to copy.
     */
    private Builder(com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.SorIdentifier)) {
        this.SorIdentifier = data().deepCopy(fields()[0].schema(), other.SorIdentifier);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder setSorIdentifier(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder clearSorIdentifier() {
      SorIdentifier = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder setEntityName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder clearEntityName() {
      EntityName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder setEntityTypeIdentifier(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder clearEntityTypeIdentifier() {
     ...
     *
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder setParentSorIdentifier(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.show_me_kafka.sor.sor_producer.model.kafka.HealthInstitution.Builder clearParentSorIdentifier() {
    ...
    public HealthInstitution build() {
      try {
        HealthInstitution record = new HealthInstitution();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<HealthInstitution>
    WRITER$ = (org.apache.avro.io.DatumWriter<HealthInstitution>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<HealthInstitution>
    READER$ = (org.apache.avro.io.DatumReader<HealthInstitution>)MODEL$.createDatumReader(SCHEMA$);
